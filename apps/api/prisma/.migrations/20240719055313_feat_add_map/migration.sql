/*
  ...
  - You are about to drop the `eventpicture` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `myticket` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `coupon` DROP FOREIGN KEY `Coupon_includedEventCategoryId_fkey`;

-- DropForeignKey
ALTER TABLE `coupon` DROP FOREIGN KEY `Coupon_includedEventId_fkey`;

-- DropForeignKey
ALTER TABLE `event` DROP FOREIGN KEY `Event_genreId_fkey`;
...
-- DropForeignKey
ALTER TABLE `eventpicture` DROP FOREIGN KEY `EventPicture_eventId_fkey`;

-- DropForeignKey
ALTER TABLE `eventticket` DROP FOREIGN KEY `EventTicket_eventId_fkey`;

-- DropForeignKey
ALTER TABLE `eventticket` DROP FOREIGN KEY `EventTicket_scheduleId_fkey`;

-- DropForeignKey
ALTER TABLE `location` DROP FOREIGN KEY `Location_regionId_fkey`;

-- DropForeignKey
ALTER TABLE `myticket` DROP FOREIGN KEY `MyTicket_EventTicketId_fkey`;

-- DropForeignKey
ALTER TABLE `myticket` DROP FOREIGN KEY `MyTicket_customerId_fkey`;

-- DropForeignKey
ALTER TABLE `organizer` DROP FOREIGN KEY `Organizer_userId_fkey`;

-- DropForeignKey
ALTER TABLE `referral` DROP FOREIGN KEY `Referral_couponId_fkey`;

-- DropForeignKey
ALTER TABLE `referral` DROP FOREIGN KEY `Referral_customerId_fkey`;
...
-- DropForeignKey
ALTER TABLE `transaction` DROP FOREIGN KEY `Transaction_statusId_fkey`;
...
-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_roleId_fkey` FOREIGN KEY (`roleId`) REFERENCES `rolas`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
